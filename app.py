...
MODEL_PATH = "model"  # Vosk model klasörü
SAMPLE_RATE = 16000
CHANNELS = 1
DURATION = 5
...
def tts_speak_immediate_local(text):
    ...
    try:
        ...
        # bazı platformlarda TTS başlama/bitme debug çıktısı faydalı:
        # print("TTS engine created, speaking...")
        engine.say(text)
        engine.runAndWait()
        ...
        try:
            ...
            pass
        # küçük bekleme ile cihazların tam serbest kalmasını sağla
        time.sleep(0.05)
